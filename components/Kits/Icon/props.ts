...
export type IconName =  "close" | "warning-outlined" | "check" | "info-outlined" | "github" | "code" | "moon" | "hash" | "nested-list" | "clock" | "time" | "history" | "list" | "info" | "headphones" | "music" | "song" | "film" | "show" | "book" | "suitcase" | "sun" | "warning" | "check-outlined" | "education" | "download" | "copy-outline" | "focus-center" | "timeline" | "calendar" | "gallery" | "tools" | "measure" | "chevron-right" | "whatsapp" | "telegram" | "skype" | "linkedin" | "email"
