...
Front-end programming is getting more advanced every day, new solutions New solutions have entered the scene based on new needs, and we have to adapt our apps with performant solutions.
...
<Code
  language="javascript"
  code={`export const getStaticProps = async ({ params }) => {
...
<Code
  language="javascript"
  code={`// hooks/useProduct.js
import { endpoints } from "@constants";
import { useDebugValue } from "react";
export useSWRImmutable from "swr/immutable";
...
But if your data has dynamic parts that have different values for different users ( like isLiked and similars property in out first example of 5th strategy ), you should choose 5th strategy for your page.
