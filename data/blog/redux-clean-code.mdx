...
Before choosing redux for state management, please consider reading [Why Do You Need to Rethink About Using Redux](/blog/rethink-using-redux) blog first. If you still want to use redux for your next project, keep on reading the rest of this blog.
...
In redux saga a worker is a generator function like this:
