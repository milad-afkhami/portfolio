...
In this blog, I want to describe how I handle theming of my projects. Whether it is multi-theme or not, I like to keep things organized. A clear example of it is my portfolio which is open source and you can check it out [here](https://github.com/milad-afkhami/portfolio).
...
##### \* We'll see what the **GlobalColors** component does later.
...
##### \* You can pass any **[valid CSS color variable](https://www.w3schools.com/cssref/css_colors_legal.asp)** to the Color constructor.
...
##### \* You can generate your color palette variants with help of **[this website](http://mcg.mbitson.com/)**.
...
##### \* Don't panic! these complex functions are well tested, so just copy and paste them, and you will be okay.

##### \*\* We import **GlobalColors** component into our most top-level component.
