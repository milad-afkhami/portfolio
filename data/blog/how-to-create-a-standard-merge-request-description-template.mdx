...
- [ ] This merge request follows [the standard style guides](LINK_TO_THE_STYLE_GUIDE_DOCUMENTATION).
- [ ] This merge request follows [the git workflow guidelines](LINK_TO_THE_GIT_WORKFLOW_DOCUMENTATION).
...
- [ ] The commit messages adhere to [the git commit message convention standards](LINK_TO_THE_GIT_COMMIT_MESSAGE_CONVENTION_DOCUMENTATION).
...
Feel free to replace `LINK_TO_THE_STYLE_GUIDE_DOCUMENTATION`, `LINK_TO_THE_GIT_WORKFLOW_DOCUMENTATION`, and `LINK_TO_THE_GIT_COMMIT_MESSAGE_CONVENTION_DOCUMENTATION` with the actual URLs.
