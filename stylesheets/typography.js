...
export const typographyVariants = {
  ...
  default: {
    "h-lg": { fontSize: 22, fontWeight: "normal" },
    "h-lg-b": { fontSize: 22, fontWeight: "bold" },
    "h-md": { fontSize: 18, fontWeight: "normal" },
    "h-md-b": { fontSize: 18, fontWeight: "bold" },
    // "h-sm": { fontSize: 16, fontWeight: "normal" },
    // "h-sm-b": { fontSize: 16, fontWeight: "bold" },
