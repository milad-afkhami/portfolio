...
- [ ] This merge request follows [the standard style guides](LINK_TO_STYLE_GUIDE_DOCUMENTATION) and [the git workflow guidelines](LINK_TO_GIT_WORKFLOW_DOCUMENTATION).
...
- [ ] The commits of this merge request can be squashed, or I have [interactively rebased](https://confluence.xsystem.ir/display/ITC/Rebasing) the commits to ensure a clean history.
